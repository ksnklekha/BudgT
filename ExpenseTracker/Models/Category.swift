...
enum Category: String, CaseIterable {
    ...
    var systemNameIcon: String {
        ...
        case .health: return "pills.circle.fill"
        case .shopping: return "cart"
        case .transportation: return "car.fill"
        case .utilities: return "bolt.circle"
    ...
    var color: Color {
        ...
        case .utilities: return Color(#colorLiteral(red: 1.232323, green: 0.8543232, blue: 0,alpha: 1))
